...
export class MyMCP extends McpAgent<Env, Record<string, never>, Props> {
	...
	async init() {
	  ...
	  this.server.tool("crm_batch_create_companies",
	  ...
	  this.server.tool("crm_batch_update_companies",
	  ...
	  this.server.tool("crm_get_company_properties",
	  ...
	  this.server.tool("crm_create_company_property",
	    ...
	    async (params) => {
	      return this.handleEndpoint(async () => {
	        const endpoint = '/crm/v3/properties/companies'
	        return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'POST', params)
	      })
	    }
	  )
	  ...
	  this.server.tool("crm_list_objects",
	  ...
	  this.server.tool("crm_get_object",
	  ...
	  this.server.tool("crm_create_object",
	  ...
	  this.server.tool("crm_update_object",
	  ...
	  this.server.tool("crm_archive_object",
	    ...
	    async (params) => {
	      return this.handleEndpoint(async () => {
	        const endpoint = `/crm/v3/objects/${params.objectType}/${params.objectId}`
	        return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'DELETE')
	      })
	    }
	  )

	  this.server.tool("crm_search_objects",
	  ...
	  this.server.tool("crm_batch_create_objects",
	  ...
	  this.server.tool("crm_batch_read_objects",
	    "Create multiple CRM objects in a single request",
	    {
	      objectType: z.enum(['companies', 'contacts', 'deals', 'tickets', 'products', 'line_items', 'quotes', 'custom']),
	  ...
	  this.server.tool("crm_batch_update_objects",
	  ...
	  this.server.tool("crm_batch_archive_objects",
	  ...
	  this.server.tool("crm_list_association_types",
	  ...
	  this.server.tool("crm_get_associations",
	  ...
	  this.server.tool("crm_create_association",
	    ...
	    async (params) => {
	      return this.handleEndpoint(async () => {
	        ...
	        return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'PUT', {
	  ...
	  this.server.tool("crm_archive_association",
	  ...
	  this.server.tool("crm_batch_create_associations",
	  ...
	  this.server.tool("crm_batch_archive_associations",
	  ...
	  this.server.tool("crm_create_contact",
	  ...
	  this.server.tool("crm_update_contact",
	  ...
	  this.server.tool("crm_get_contact",
	  ...
	  this.server.tool("crm_search_contacts",
	  ...
	  this.server.tool("crm_batch_create_contacts",
	  ...
	  this.server.tool("crm_batch_update_contacts",
	  ...
	  this.server.tool("crm_get_contact_properties",
	  ...
	  this.server.tool("crm_create_contact_property",
	  ...
	  this.server.tool("crm_create_lead",
	  ...
	  this.server.tool("crm_update_lead",
	  ...
	  this.server.tool("crm_search_leads",
	  ...
	  this.server.tool("crm_batch_create_leads",
	  ...
	  this.server.tool("crm_batch_update_leads",
	  ...
	  this.server.tool("crm_get_lead_properties",
	  ...
	  this.server.tool("crm_create_lead_property",
	  ...
	  this.server.tool("meetings_list",
	  ...
	  this.server.tool("meetings_create",
	  ...
	  this.server.tool("meetings_update",
	  ...
	  this.server.tool("meetings_archive",
	  ...
	  this.server.tool("meetings_search",
	  ...
	  this.server.tool("meetings_batch_create",
	  ...
	  this.server.tool("meetings_batch_update",
	  ...
	  this.server.tool("meetings_batch_archive",
	  ...
	  this.server.tool("notes_archive",
	  ...
	  this.server.tool("notes_batch_create",
	  ...
	  this.server.tool("notes_batch_read",
	  ...
	  this.server.tool("notes_batch_update",
	  ...
	  this.server.tool("notes_batch_archive",
	  ...
	  this.server.tool("tasks_archive",
	  ...
	  this.server.tool("tasks_batch_create",
	  ...
	  this.server.tool("tasks_batch_read",
	  ...
	  this.server.tool("tasks_batch_update",
	  ...
	  this.server.tool("tasks_batch_archive",
	  ...
	  this.server.tool("engagement_details_get",
	  ...
	  this.server.tool("engagement_details_create",
	  ...
	  this.server.tool("engagement_details_update",
	  ...
	  this.server.tool("engagement_details_list",
	  ...
	  this.server.tool("engagement_details_archive",
	  ...
	  this.server.tool("engagement_details_get_associated",
	  ...
	  this.server.tool("calls_archive",
	  ...
	  this.server.tool("calls_batch_create",
	  ...
	  this.server.tool("calls_batch_read",
	  ...
	  this.server.tool("calls_batch_update",
	  ...
	  this.server.tool("calls_batch_archive",
	  ...
	  this.server.tool("emails_create",
	  ...
	  this.server.tool("emails_update",
	  ...
	  this.server.tool("emails_archive",
	  ...
	  this.server.tool("emails_search",
	  ...
	  this.server.tool("emails_batch_create",
	  ...
	  this.server.tool("emails_batch_read",
	  ...
	  this.server.tool("emails_batch_update",
	  ...
	  this.server.tool("emails_batch_archive",
	  ...
	  this.server.tool("communications_get_preferences",
	  ...
	  this.server.tool("communications_update_preferences",
	    ...
	    async (params) => {
	      return this.handleEndpoint(async () => {
	        ...
	        return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'PUT', params.preferences)
	      })
	    }
	  )

	  this.server.tool("communications_unsubscribe_contact",
	  ...
	  this.server.tool("communications_subscribe_contact",
	  ...
	  this.server.tool("communications_get_subscription_definitions",
	  ...
	  this.server.tool("communications_get_subscription_status",
	  ...
	  this.server.tool("communications_update_subscription_status",
	  ...
	  this.server.tool("products_list",
	    ...
	    async params => this.handleEndpoint(async () => {
	  ...
	  this.server.tool("products_read",
	  ...
	  this.server.tool("products_create",
	    ...
	    async params => this.handleEndpoint(async () => {
	      const endpoint = '/crm/v3/objects/products'
	      return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'POST', { properties: params.properties })
	    })
	  )

	  this.server.tool("products_update",
	    ...
	    async params => this.handleEndpoint(async () => {
	      const endpoint = `/crm/v3/objects/products/${params.productId}`
	      return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'PATCH', { properties: params.properties })
	    })
	  )

	  this.server.tool("products_archive",
	  ...
	  this.server.tool("products_search",
	    "Search products",
	    {
	  ...
	  this.server.tool("products_batch_archive",
	    ...
	    async params => this.handleEndpoint(async () => {
	      ...
	      return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'POST', { inputs: params.productIds.map((id: string) => ({ id })) })
	    })
	  )

	  this.server.tool("products_batch_create",
	    ...
	    async params => this.handleEndpoint(async () => {
	      ...
	      return await this.makeApiRequestWithErrorHandling(hubspotAccessToken, endpoint, {}, 'POST', { inputs: params.inputs })
	    })
	  )

	  this.server.tool("products_batch_read",
	  ...
	  this.server.tool("products_batch_update",
